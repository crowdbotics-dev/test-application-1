"""
Django settings for test_application_1 project.
...
ROOT_URLCONF = 'test_application_1.urls'
...
WSGI_APPLICATION = 'test_application_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "test application Support <support@test-application-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_application_1 API",
    "DESCRIPTION": "API documentation for test_application_1 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "test_application_1.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "test_application_1.storage_backends.AzureStaticStorage"
